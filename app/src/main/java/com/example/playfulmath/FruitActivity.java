    ...
    public void onClick(View v){
        ...
        switch (v.getId()){
            ...
            case R.id.pearCardView:
                i = new Intent(FruitActivity.this, BadgeActivity.class);
                startActivity(i);
                finish();
                break;
            ...
            case R.id.grapeCardView:
                i = new Intent(FruitActivity.this, RankingListActivity.class);
                startActivity(i);
                finish();
                break;
            case R.id.strawberryCardView:
                i = new Intent(FruitActivity.this, LoginActivity.class);
                startActivity(i);
                finish();
                break;
